...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('cities', function(Blueprint $table) {
			$table->foreign('governorte_id')->references('id')->on('governortes')
						->onDelete('no action')
						->onUpdate('no action');
		});
	...
	public function down()
	{
		...
		Schema::table('cities', function(Blueprint $table) {
			$table->dropForeign('cities_governorte_id_foreign');
		});
		Schema::table('posts', function(Blueprint $table) {
		...
		Schema::table('client_governorate', function(Blueprint $table) {
			$table->dropForeign('client_governorate_governorte_id_foreign');
		});
	}
}